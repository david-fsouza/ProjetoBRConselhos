...
/**
 * Classe de execução da função Pagamento Automatizado, deve executar os
 * seguintes testes:
 * 
 * Inclusão de novo registro Consulta do registro Validar itens de Liquidação
...
public class PagamentoAutomatizado extends BaseTest {
	...
	public void FinalizaTest() throws IOException {
		...
		FileUtils.copyFile(arquivo,
				new File("target/screenshot/Financeiro/Pagamento Automatizado/" + testNome.getMethodName() + ".jpg"));
	}
